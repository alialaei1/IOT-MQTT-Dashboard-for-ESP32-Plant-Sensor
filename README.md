...
[nilinet](http://www.nilinet.com) is an open-source IoT dashboard for device management, smart system, visualization, and energy management system. [nilinet](http://www.nilinet.com) enables device connectivity via standard protocol, for example WebSocket. [nilinet](http://www.nilinet.com) uses MongoDB , This is an open-source, non-relational database that combines three key qualities: scalable, schemaless, and queryable. 
